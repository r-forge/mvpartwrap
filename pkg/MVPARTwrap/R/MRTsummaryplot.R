...
plot.MRT<-function(x,NodeMarking=TRUE,typeplot=c('tree','triordi'),test.F=FALSE,silent=TRUE,Cex=0.5,widthtree=7, heighttree=9,widthtriordi=7, heighttriordi=9,R2A=FALSE,X=NULL,T=NULL,...)
{
